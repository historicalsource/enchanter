...
?ELS155:	CALL	WT?,WRD,PS?DIRECTION,P1?DIRECTION >VAL
	ZERO?	VAL /?ELS168
	EQUAL?	VERB,FALSE-VALUE,ACT?WALK,ACT?FLY \?ELS168
	EQUAL?	LEN,1 /?THN171
	EQUAL?	LEN,2 \?ELS174
...
?CND81:	PUT	OOPS-TABLE,O-PTR,FALSE-VALUE
	ZERO?	DIR /?ELS249
	SET	'PRSA,V?WALK
	EQUAL?	VERB,ACT?FLY \?ELS253
	SET	'TRY-FLY,TRUE-VALUE
	JUMP	?CND251
?ELS253:	SET	'TRY-FLY,FALSE-VALUE
?CND251:	SET	'PRSO,DIR
	SET	'P-OFLAG,FALSE-VALUE
	SET	'P-WALK-DIR,DIR
	SET	'AGAIN-DIR,DIR
	RETURN	AGAIN-DIR
?ELS249:	ZERO?	P-OFLAG /?CND258
	CALL	ORPHAN-MERGE
?CND258:	SET	'P-WALK-DIR,FALSE-VALUE
...
?CND38:	CALL	DO-SL,PLAYER,SH,SC
	...
	ZERO?	P-ADJ /?CND45
	EQUAL?	P-NAM,W?SPELL,FALSE-VALUE \?CND45
	SET	'P-NAM,P-ADJN
?CND45:	CALL	SPELL-CHECK,TBL,P-NAM
?CND32:	GET	TBL,P-MATCHLEN
	SUB	STACK,TLEN >LEN
	BTST	P-GETFLAGS,P-ALL \?ELS52
	JUMP	?CND50
?ELS52:	BTST	P-GETFLAGS,P-ONE \?ELS54
	ZERO?	LEN /?ELS54
	EQUAL?	LEN,1 /?CND57
	RANDOM	LEN
	GET	TBL,STACK
	...
	PRINTI	"?)"
	CRLF	
?CND57:	PUT	TBL,P-MATCHLEN,1
	JUMP	?CND50
?ELS54:	GRTR?	LEN,1 /?THN66
	ZERO?	LEN \?CND50
	EQUAL?	P-SLOCBITS,-1 /?CND50
?THN66:	EQUAL?	P-SLOCBITS,-1 \?ELS72
...
?ELS72:	ZERO?	LEN \?CND75
	SET	'LEN,OLEN
?CND75:	EQUAL?	WINNER,PLAYER /?ELS80
	CALL	CANT-ORPHAN
	RFALSE	
?ELS80:	ZERO?	VRB /?ELS82
	ZERO?	P-NAM /?ELS82
	CALL	WHICH-PRINT,TLEN,LEN,TBL
	EQUAL?	TBL,P-PRSO \?ELS89
	PUSH	P-NC1
	JUMP	?CND85
?ELS89:	PUSH	P-NC2
?CND85:	SET	'P-ACLAUSE,STACK
	SET	'P-AADJ,P-ADJ
	SET	'P-ANAM,P-NAM
	CALL	ORPHAN,FALSE-VALUE,FALSE-VALUE
	SET	'P-OFLAG,TRUE-VALUE
	JUMP	?CND78
?ELS82:	ZERO?	VRB /?CND78
	PRINTI	"There seems to be a noun missing in that sentence!"
	CRLF	
?CND78:	SET	'P-NAM,FALSE-VALUE
	SET	'P-ADJ,FALSE-VALUE
	RFALSE	
?CND50:	ZERO?	LEN \?ELS99
	ZERO?	GCHECK /?ELS99
	ZERO?	VRB /?CND102
	SET	'P-SLOCBITS,XBITS
	ZERO?	LIT \?THN109
	EQUAL?	PRSA,V?TELL \?ELS108
?THN109:	CALL	OBJ-FOUND,NOT-HERE-OBJECT,TBL
	SET	'P-XNAM,P-NAM
	SET	'P-XADJ,P-ADJ
	SET	'P-XADJN,P-ADJN
	...
	RTRUE	
?ELS108:	PRINTI	"It's too dark to see!"
	CRLF	
?CND102:	SET	'P-NAM,FALSE-VALUE
	SET	'P-ADJ,FALSE-VALUE
	RFALSE	
?ELS99:	ZERO?	LEN \?CND97
	SET	'GCHECK,TRUE-VALUE
	JUMP	?PRG30
?CND97:	SET	'P-SLOCBITS,XBITS
	SET	'P-NAM,FALSE-VALUE
	SET	'P-ADJ,FALSE-VALUE
	RTRUE	
